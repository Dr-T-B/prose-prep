...
const DISPLAY_OVERRIDES: Record<DatasetKey, string> = {
  ...
  interpretive_tensions: "Interpretive Extensions",
...
const NOTES: Record<DatasetKey, string> = {
  ...
  themes: "Stores thematic links and conceptual theme structures.",
  ...
  interpretive_tensions: "Stores interpretive tensions, debates, and alternative readings.",
